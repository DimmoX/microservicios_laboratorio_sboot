...
export const routes: Routes = [
  ...
  { path: 'examenes', component: ExamenListComponent, canActivate: [authGuard] },
  ...
  { path: 'usuarios', component: UsuarioListComponent, canActivate: [authGuard, labEmployeeGuard] },
  { path: 'usuarios/nuevo', component: UsuarioFormComponent, canActivate: [authGuard, labEmployeeGuard] },
  { path: 'usuarios/editar/:id', component: UsuarioFormComponent, canActivate: [authGuard, labEmployeeGuard] },

  // Rutas para PATIENT
  { path: 'mis-resultados', component: ResultadoListComponent, canActivate: [authGuard, patientGuard] }, // TODO: Filtrar solo sus resultados
  { path: 'agendar', component: ExamenListComponent, canActivate: [authGuard, patientGuard] }, // TODO: Crear componente de agenda
